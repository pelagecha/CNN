...
class Attention(nn.Module):
    def __init__(self, in_channels):
        ...
        # The attention mechanism can be implemented using a 1x1 convolution
        # followed by a sigmoid activation to generate the attention map.
    ...
    def forward(self, x):
        ...
        # Apply attention map: element-wise multiplication
        x = x * attention_map
        return x
...
class Model(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        # Attention mechanism
        self.attention = Attention(conv4_out)  # Apply attention on the last conv layer output
    ...
    def _forward_conv(self, x):
        ...
        # Apply attention after last convolutional layer
        x = self.attention(x)
    ...
    @staticmethod
    def model_name():
        return "cnnBatchNormAttention90"
